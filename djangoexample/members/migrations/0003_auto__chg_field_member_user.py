...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('members_member', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['auth.User'], unique=True))

    def backwards(self, orm):

        # Changing field 'Member.user'
        db.alter_column('members_member', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))
