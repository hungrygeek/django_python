...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'members_member', 'name')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'members_member', 'name',
                      self.gf('django.db.models.fields.CharField')(default='BLANK_NAME', max_length=200),
                      keep_default=False)

        # Adding field 'Member.email'
        db.add_column(u'members_member', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=200, blank=True),
                      keep_default=False)
