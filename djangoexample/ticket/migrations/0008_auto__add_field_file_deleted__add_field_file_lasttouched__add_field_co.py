...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'File.deleted'
        db.add_column('ticket_file', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'File.lasttouched'
        db.add_column('ticket_file', 'lasttouched',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 17, 0, 0)),
                      keep_default=False)

        # Adding field 'Comment.deleted'
        db.add_column('ticket_comment', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Ticket.deleted'
        db.add_column('ticket_ticket', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Ticket.lasttouched'
        db.add_column('ticket_ticket', 'lasttouched',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 17, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'File.deleted'
        db.delete_column('ticket_file', 'deleted')

        # Deleting field 'File.lasttouched'
        db.delete_column('ticket_file', 'lasttouched')

        # Deleting field 'Comment.deleted'
        db.delete_column('ticket_comment', 'deleted')

        # Deleting field 'Ticket.deleted'
        db.delete_column('ticket_ticket', 'deleted')

        # Deleting field 'Ticket.lasttouched'
        db.delete_column('ticket_ticket', 'lasttouched')
